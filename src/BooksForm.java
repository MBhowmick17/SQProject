...
public class BooksForm extends JFrame {
	...
	public BooksForm() {
		...
		lblCallNo.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblCallNo.setSize(100, 30);
		...
		btnAddBooks.addActionListener(new ActionListener() {
			...
			assert Integer.parseInt(textField.getText()) > 0 : "Call No. should be greater than zero and numeric.";
			assert Integer.parseInt(textField_4.getText()) > 0 : "Quantity should be greater than zero.";
			...
			assert i>0 : "Some server error happened";
