...
public class LibrarianForm extends JFrame {
	...
	public LibrarianForm() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			assert textField.getText().length() >= 2 : "Name should not be less than 2 character.";
			assert String.valueOf(passwordField.getPassword()).length() >= 5 : "Password should not be less than 5 character.";
